...
FEATURES = {
  ...
  "use_fca":  # these cars use the [ FCA11 ] message for the AEB and FCW signals, all others use [ SCC12 ]
    set([CAR.SONATA, CAR.PALISADE, CAR.ELANTRA_I30, CAR.ELANTRA21, CAR.ELANTRA21_HEV, CAR.KONA, CAR.KONA_HEV,
         CAR.IONIQ_HEV,
         CAR.GENESIS_G70, CAR.FORTE, CAR.STINGER, CAR.K9, CAR.K7]),
  "has_scc13": {CAR.PALISADE, CAR.NIRO_HEV, CAR.K9, CAR.GENESIS_G90, CAR.K5_DL3, CAR.K5_DL3_HEV, CAR.K7},
  "has_scc14": {CAR.PALISADE, CAR.NIRO_HEV, CAR.K9, CAR.GENESIS_G90, CAR.K5_DL3, CAR.K5_DL3_HEV, CAR.K7},
...
SP_CARS = [CAR.GENESIS, CAR.GENESIS_G70, CAR.GENESIS_G80, CAR.GENESIS_G90, CAR.K9, CAR.K7]
